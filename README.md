...
**数据时效性说明**：院校排名与专业代码均为应用内置的静态数据，具有时效性——排名对应软科 2026 年榜单（每年约 4 月更新），专业目录对应教育部 2022 年版（隔数年修订），应用内不会联网刷新。上述数据仅供查询参考，请以官方最新发布为准，使用前请自行确认是否仍为最新版本；需要更新时重跑 `tool/` 下对应抓取脚本并随新版本发布。
